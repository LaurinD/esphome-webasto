...
// ----- Befehle -----
void Webasto::VentOn(uint8_t t_on_mins){ /*...kopiere deinen VentOn Code hier...*/ }
void Webasto::VentOn(){ VentOn(1); }
void Webasto::HeatOn(uint8_t t_on_mins){ /*...kopiere HeatOn Code hier...*/ }
void Webasto::HeatOn(){ HeatOn(1); }
void Webasto::Off(){ /*...kopiere Off Code hier...*/ }
void Webasto::KeepAlive(){ /*...kopiere KeepAlive Code hier...*/ }

// ----- State lesen -----
void Webasto::get_state_50_03(){ /*...kopiere get_state_50_03 Code hier...*/ }
void Webasto::get_state_50_04(){ /*...kopiere get_state_50_04 Code hier...*/ }
void Webasto::get_state_50_05(){ /*...kopiere get_state_50_05 Code hier...*/ }
void Webasto::get_state_50_06(){ /*...kopiere get_state_50_06 Code hier...*/ }
void Webasto::get_state_50_07(){ /*...kopiere get_state_50_07 Code hier...*/ }

void Webasto::setup(){}
void Webasto::loop(){ /*...kopiere loop() Code hier...*/ }
